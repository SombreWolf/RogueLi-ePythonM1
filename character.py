...
class Character:
    ...
    def attacks(self, target):
        """
        function to deal damage to another character
        :param target:
        :return:
        """
        while target.alive:
    ...
    def defence(self, damage):
        """
        function to reduce the damage incoming
        :param damage:
        :return:
        """
    ...
    def show_exp(self):
        """
        function to display the exp won when you kill a character class
        :return:
        """
    ...
    def level_up(self, exp):
        """
        function to do when you level up to upgrade your statistics
        :param exp:
        :return:
        """
        up = False
    ...
    def show_loot(self):
        """
        function to display the loot on the screen
        :return:
        """
    ...
    def obtain(self, inv):
        """
        function to loot the stuff of a monster
        :param inv:
        :return:
        """
