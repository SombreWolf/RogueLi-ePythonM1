...
class Generator():
    ...
    def __init__(self, width=80, height=70, max_rooms=4, min_room_xy=3,

                 max_room_xy=10, rooms_overlap=False, random_connections=1,

                 random_spurs=5, tiles=CHARACTER_TILES):
    ...
    def new_map_player(self):
        ...
        print(self.tiles_level[y])
        return [x,y]
##    def test_room (self,y,x):
##        count = 0
...
if __name__ == '__main__':
    ...
    gen.init_monster(["ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull","ghost","bull"])
    gen.init_exit()
